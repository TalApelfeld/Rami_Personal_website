...
import { Phone, Mail, CheckCircle, User, Stethoscope, Award, Clock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50" dir="rtl">
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4 space-x-reverse">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">רפואה תעסוקתית ובריאות הציבור</p>
              </div>
            </div>
            <nav className="hidden md:flex space-x-8 space-x-reverse">
              <a href="#about" className="text-gray-700 hover:text-blue-900 transition-colors">אודות</a>
              <a href="#services" className="text-gray-700 hover:text-blue-900 transition-colors">שירותים</a>
              <a href="#qualifications" className="text-gray-700 hover:text-blue-900 transition-colors">התמחויות</a>
              <a href="#contact" className="text-gray-700 hover:text-blue-900 transition-colors">יצירת קשר</a>
            </nav>
          </div>
        </div>
      </header>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-8 leading-relaxed">
                בעל ניסיון רב בעבודה עם גופים תעשייתיים, מוסדות רפואיים, קרנות פנסיה וביטוח לאומי. 
                מתמחה בקביעת דרגות נכות, ניהול סיכונים רפואיים וייעוץ תעסוקתי מקצועי.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#contact" className="bg-white text-blue-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-center">
                  לתיאום פגישה
                </a>
                <a href="tel:0504848950" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-900 transition-colors text-center">
                  התקשר עכשיו
                </a>
              </div>
            </div>
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">אודותי</h2>
            <div className="w-24 h-1 bg-blue-900 mx-auto"></div>
          </div>
          
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">מומחיות מקצועית</h3>
              <p className="text-gray-700 text-lg leading-relaxed mb-6">
                כרופא מומחה ברפואה תעסוקתית ובריאות הציבור, אני מביא ניסיון עשיר של שנים רבות בתחום. 
                התמחותי כוללת הערכות רפואיות מקיפות, ייעוץ תעסוקתי מקצועי, וכתיבת חוות דעת משפטיות מדויקות.
              </p>
              <p className="text-gray-700 text-lg leading-relaxed">
                אני עובד בשיתוף פעולה הדוק עם גופים תעשייתיים, מוסדות רפואיים מובילים, קרנות פנסיה, 
                וביטוח לאומי כדי להבטיח טיפול מקצועי ויעיל בכל מקרה.
              </p>
            </div>
            
            <div className="bg-gray-50 rounded-2xl p-8">
              <h4 className="text-xl font-bold text-gray-900 mb-6">תפקידים נוכחיים</h4>
              <div className="space-y-4">
                <div className="flex items-start space-x-3 space-x-reverse">
                  <CheckCircle className="w-6 h-6 text-green-600 mt-1 flex-shrink-0" />
                  <p className="text-gray-700">רופא תעסוקתי במחוז דרום - קופת חולים מאוחדת</p>
                </div>
                <div className="flex items-start space-x-3 space-x-reverse">
                  <CheckCircle className="w-6 h-6 text-green-600 mt-1 flex-shrink-0" />
                  <p className="text-gray-700">רופא קרן בוועדות רפואיות מטעם קרנות פנסיה</p>
                </div>
                <div className="flex items-start space-x-3 space-x-reverse">
                  <CheckCircle className="w-6 h-6 text-green-600 mt-1 flex-shrink-0" />
                  <p className="text-gray-700">יועץ רפואי למגזר התעשייתי והעסקי</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="qualifications" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">התמחויות והסמכות</h2>
            <div className="w-24 h-1 bg-blue-900 mx-auto"></div>
          </div>
            ...
            {[
              ...
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <div className="w-full h-1 bg-blue-100 rounded">
                  <div className="h-1 bg-blue-900 rounded" style={{ width: '100%' }}></div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="services" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">שירותים מקצועיים</h2>
            <div className="w-24 h-1 bg-blue-900 mx-auto"></div>
          </div>
      ...
      <section id="contact" className="py-20 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="tel:0504848950" className="text-blue-300 hover:text-blue-200 transition-colors">
                      0504848950
                    </a>
                  </div>
                </div>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="mailto:Dr.RamiMor@gmail.com" className="text-blue-300 hover:text-blue-200 transition-colors">
            ...
            {/* Contact Form */}
            <div>
              <h3 className="text-2xl font-bold mb-8">השאר פרטים ונחזור אליך</h3>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-medium mb-2">דואר אלקטרוני</label>
                  <input
                    type="email"
                    id="email"
                    name="email"
                ...
                <div>
                  <label htmlFor="subject" className="block text-sm font-medium mb-2">נושא הפנייה</label>
                  <select
                    id="subject"
                    name="subject"
                  ...
                  >
                    ...
                    <option value="fitness-for-work">בדיקת כשירות לעבודה</option>
